                        ...
                        <div className="row page-titles">
                            <div className="col-md-5 align-self-center">
                                <ol className="breadcrumb justify-content">
                                    ...
                                    <li className="breadcrumb-item active">Cooked Product Details</li>
                                </ol>
                            </div>
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/addcooked">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col-9">
                                                <h4 className="text-muted">Puttu</h4>
                                            </div>
                                            <div className="col-3">
                                                <h3>86</h3>
                                            </div>
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col-9">
                                                <h4 className="text-muted">Total Product</h4>
                                            </div>
                                            <div className="col-3">
                                                <h3>86</h3>
                                            </div>
                            ...
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col-7">
                                                <h3 className="card-title">Cooked Order Details</h3>
                                            </div>
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Puttu</td>
                                                        <td>123</td>
                                                        <td><a to="/dashboard" role="button" className="btn btn-success waves-effect btn-rounded waves-light" >
