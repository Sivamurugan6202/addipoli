                        ...
                        <div className="row page-titles">
                            <div className="col-md-5 align-self-center">
                                <ol className="breadcrumb justify-content">
                                    ...
                                    <li className="breadcrumb-item active">Product List Details</li>
                                </ol>
                            </div>
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/addproduct">
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>12345</td>
                                                        <td>1234</td>
                                                        <td><a role="button" className="btn btn-success waves-effect btn-rounded waves-light" href="/editproduct">
